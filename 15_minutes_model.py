...
def __main__():
    ...
    preprocess_and_save_data("data_for_15_minutes_model")

    data = load_object("data_for_15_minutes_model.pkl")
    ...
    get_model(data=training_data,
              number_of_timesteps_to_predict=15,
              save_to_file=True,
              model_name="15_minutes_model",
              verbose=True)
